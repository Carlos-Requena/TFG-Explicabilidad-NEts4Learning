...
export class MODEL_3_MOVE_NET_POSE_NET extends I_MODEL_OBJECT_DETECTION {
   ...
   */
  _modelDetector: poseDetection.PoseDetector | null = null
...
`}
  ...
  async PREDICTION (input_image_or_video: HTMLImageElement | HTMLVideoElement | HTMLCanvasElement, config = { flipHorizontal: false }) {
    if (this._modelDetector === null) return []
    /**
     * @type {poseDetection.MoveNetEstimationConfig}
     */
    const estimationConfig__MoveNet: poseDetection.MoveNetEstimationConfig = {
     ...
     */
    // const _estimationConfig__PoseNet: poseDetection.PoseNetEstimationConfig = {
    //   maxPoses      : 5,
    //   flipHorizontal: config.flipHorizontal,
    //   scoreThreshold: 0.3,
    //   nmsRadius     : 20
   ...
   */
  RENDER (ctx: CanvasRenderingContext2D, poses: poseDetection.Pose[]) {
