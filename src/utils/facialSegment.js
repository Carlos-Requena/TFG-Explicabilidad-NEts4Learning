export function getFaceSegmentMap(prediccion, width, height) {
    ...
    if (typeof document === 'undefined' || totalPixels === 0 || !prediccion || prediccion.length === 0) {
        return emptyResult;
    }
    ...
    const LAYERS = [
        ...
        { id: 2, name: 'lips', indices: [61, 146, 91, 181, 84, 17, 314, 405, 321, 375, 291, 409, 270, 269, 267, 0, 37, 39, 40, 185] },
        { id: 3, name: 'rightEye', indices: [33, 246, 161, 160, 159, 158, 157, 173, 133, 155, 154, 153, 145, 144, 163, 7] },
        { id: 4, name: 'leftEye', indices: [263, 466, 388, 387, 386, 385, 384, 398, 362, 382, 381, 380, 374, 373, 390, 249] },
        { id: 5, name: 'rightEyebrow', indices: [46, 53, 52, 65, 55, 70, 63, 105, 66, 107] },
        { id: 6, name: 'leftEyebrow', indices: [276, 283, 282, 295, 285, 300, 293, 334, 296, 336] },
